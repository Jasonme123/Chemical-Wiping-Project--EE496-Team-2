...
// *********************************************************************
  ...
  LCDML_add         (0  , LCDML_0         , 1  , "Amount of Distance"   , mFunc_information);   // this menu function can be found on "LCDML_display_menuFunction" tab
  LCDML_add         (1  , LCDML_0         , 2  , "Number of Cycles" , mFunc_timer_info);        // this menu function can be found on "LCDML_display_menuFunction" tab
  LCDML_add         (2  , LCDML_0         , 3  , "Type of Liquid"   , NULL);                    // NULL = no menu function
  LCDML_add         (3  , LCDML_0_3       , 1  , "Water"            , NULL);                    // NULL = no menu function
