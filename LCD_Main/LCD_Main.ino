...
LCDML_add         (18 , LCDML_0_2       , 2  , "Start Homing"     , z_homing);                   
LCDML_add         (19 , LCDML_0_2       , 3  , "Back"             , mFunc_back_by_1);   
...
LCDML_add         (23 , LCDML_0_5       , 1  , "X&Z AXES HOMING"  , NULL);                    
LCDML_add         (24 , LCDML_0_5       , 2  , "Start Homing"     , both_axis_homing);     
...
LCDML_add         (45 , LCDML_0_6       , 1  , "ADJUST X&Z AXES"        , NULL);                    
LCDML_addAdvanced (46 , LCDML_0_6       , 2  , NULL                     , "Move X-Axis"    , move_x_axis, 0,   _LCDML_TYPE_dynParam);  // move_x_axis
LCDML_addAdvanced (47 , LCDML_0_6       , 3  , NULL                     , "Move Z-Axis"    , move_z_axis, 0,   _LCDML_TYPE_dynParam);   // move_z_axis  
